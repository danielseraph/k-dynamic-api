...
async function runTests() {
  ...
  const assertTest = (name: string, condition: boolean, details?: any) => {
    if (condition) {
  ...
  try {
    ...
    const vesselsGetData = (await vesselsGetRes.json()) as any;
    ...
    const vesselCreateData = (await vesselCreateRes.json()) as any;
    ...
    const vesselGetOneData = (await vesselGetOneRes.json()) as any;
    ...
    const vesselUpdateData = (await vesselUpdateRes.json()) as any;
    ...
    const teamGetData = (await teamGetRes.json()) as any;
    ...
    const teamCreateData = (await teamCreateRes.json()) as any;
    ...
    const teamUpdateData = (await teamUpdateRes.json()) as any;
    ...
    const equipGetData = (await equipGetRes.json()) as any;
    ...
    const equipCreateData = (await equipCreateRes.json()) as any;
    ...
    const equipUpdateData = (await equipUpdateRes.json()) as any;
    ...
    const messageGetData = (await messageGetRes.json()) as any;
    ...
    const messageStatusData = (await messageStatusRes.json()) as any;
